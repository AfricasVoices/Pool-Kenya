...
PIPELINE_CONFIGURATION = PipelineConfiguration(
    ...
    analysis=AnalysisConfiguration(
        google_drive_upload=GoogleDriveUploadConfiguration(
            credentials_file_url="gs://avf-credentials/pipeline-runner-service-acct-avf-data-core-64cc71459fe7.json",
            drive_dir="aik_elections_analysis_outputs_ke_pool_rebuild"
        ),
        dataset_configurations=[
            ...
            make_rqa_analysis_dataset_config("aik_pool_invitation_2022"),
            make_rqa_analysis_dataset_config("aik_political_participation"),
            make_rqa_analysis_dataset_config("aik_election_conversations"),
            make_rqa_analysis_dataset_config("aik_influence_on_voting_choices"),
            make_rqa_analysis_dataset_config("aik_concern_about_safety_and_security"),
            make_rqa_analysis_dataset_config("aik_incidents_of_violence_and_polarisation"),
            make_rqa_analysis_dataset_config("aik_electoral_sexual_gender_based_violence"),
            make_rqa_analysis_dataset_config("aik_response_to_electoral_related_insecurity"),

...
PIPELINE_CONFIGURATION = PipelineConfiguration(
    ...
    analysis=AnalysisConfiguration(
        ...
        ws_correct_dataset_code_scheme=load_code_scheme("ws_correct_dataset"),
        traffic_labels=[
            TrafficLabel(label="Promos", start_date=isoparse("2023-08-12T00:00+03:00"), end_date=isoparse("2023-08-14T17:29+03:00")),
            TrafficLabel(label="SMS Ad", start_date=isoparse("2023-08-14T17:30+03:00"), end_date=isoparse("2023-08-15T08:59+03:00")),
            TrafficLabel(label="Mbaitu FM", start_date=isoparse("2023-08-15T09:00+03:00"), end_date=isoparse("2023-08-15T10:15+03:00")),
            TrafficLabel(label="After - Mbaitu FM", start_date=isoparse("2023-08-15T10:15+03:00"), end_date=isoparse("2023-08-15T24:00+03:00")),
            TrafficLabel(label="Athiani FM & Ene FM", start_date=isoparse("2023-08-16T08:00+03:00"), end_date=isoparse("2023-08-16T09:15+03:00")),
            TrafficLabel(label="After - Athiani FM & Ene FM", start_date=isoparse("2023-08-16T09:15+03:00"), end_date=isoparse("2023-08-16T24:00+03:00"))
        ]
    ),
